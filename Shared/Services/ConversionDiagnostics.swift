...
/// On-device record of how someone met Elderhub Plus before they bought it: which
...
enum ConversionDiagnostics {
    private static let logger = Logger(subsystem: "com.jackwallner.aging", category: "Conversion")
    ...
    private static let impressionPrefix = "elderhub_"
